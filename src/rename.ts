...
function main(): void {
  ...
  if (args.length < 2) {
    console.error("Usage: ts-node rename.ts <geojson-file> <id-property> [state-property] [district-property]");
    console.error("Example: ts-node rename.ts input.geojson NAME_EN ADM1_EN ADM2_EN");
    console.error("");
